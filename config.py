...
class Config():
    ...
    #URI- Unique Research Identifier
    #temparory database flask create if it cant connect to our os.environ.get('DATABASE_URL') 
    #it will  connect by default flask to sqlite db